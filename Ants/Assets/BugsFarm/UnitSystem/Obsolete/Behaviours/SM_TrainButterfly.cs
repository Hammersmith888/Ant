...
{
    [Serializable]
    public class SM_TrainButterfly : SM_TrainPikeman
    {
        protected override ObjType TrainObjectType => ObjType.str_HangingPears;

        public SM_TrainButterfly(int priority, StateAnt aiType) : base(priority, aiType) { }
