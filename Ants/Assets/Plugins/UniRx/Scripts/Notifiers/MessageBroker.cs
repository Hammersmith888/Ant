...
namespace UniRx
{
    ...
    public class MessageBroker : IMessageBroker
    {
        ...
        //private static List<MessageBroker> _brokers = new List<MessageBroker>();
        
        
        /*public static IMessageBroker Default
        {
            get
            {
        ...
        static readonly Dictionary<Type, object> notifiers = new Dictionary<Type, object>();
