        ...
        public GstuSpreadSheet(GSTU_SpreadsheetResponce data, string titleColumn, int titleRow)
        {
            ...
            foreach(GSTU_Cell cell in Cells.Values)
            {
				...
				*/
				...
				if (Cells.TryGetValue( cell.Column() + titleRow, out var gstuCell1 ))
					cell.columnId		= gstuCell1.value;

				if (Cells.TryGetValue( titleColumn + cell.Row(), out var gstuCell2 ))
					cell.rowId			= gstuCell2.value;
            }
