...
public class PC2DAdjustCameraTargetInfluence : FsmStateActionProCamera2DBase
{
	...
	public FsmFloat durationIn = 0;

	public override void OnEnter()
	{
		if (ProCamera2D.Instance != null && target.Value)
			ProCamera2D.Instance.AdjustCameraTargetInfluence(target.Value.transform, targetInfluenceH.Value, targetInfluenceV.Value, durationIn.Value);
